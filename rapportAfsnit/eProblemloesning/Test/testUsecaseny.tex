...
For at teste om de opstillede krav til databasen er overholdt udføres testen, som fremgår af \autoref{tab:testDatabase}.
 ...
 \begin{itemize}
 \item Kategorisering A er gemt i databasen 
 \end{itemize}
3.~Tryk på \textbf{REDIGER ADGANGSKODE} via hovedmenuen.
\begin{itemize}
\item MedlemsID og navn samt opdaterede kategorisering, A, vises under rediger adgangskode
\end{itemize}
 \\  \hline
  \textbf{Resultat:} &
  \hspace{1.5mm}
...
Til at teste, hvorvidt kravene til log ind er opfyldt, udføres testen, der fremgår af \autoref{tab:testLogInd}.
 ...
 \\ \hline
 	...
 	\begin{itemize}
 	\item Log ind mislykkedes. Fejlmeddelelse vises i grænsefladen for log ind
 	\end{itemize}
...
\begin{itemize}
\item Forventet log ind lykkedes og hovedmenu vises
\end{itemize}
 \\  \hline
...
\end{longtable}
 ...
 \\ \hline
 	\textbf{Main flow:} &
 	1.~Tidligere evaluering af samme træning er: \textit{:-D} og helbredstilstand \textit{MEGET DÅRLIGT}. 
Vælg \textit{TRÆNING}, \textit{KONDITIONSTRÆNING}, \textit{LØB}, \textit{MEGET DÅRLIGT} og tryk videre efter hver handling.
 	\begin{itemize}
 	\item Forventet anbefaling af træningstid er 15 min
 	\end{itemize} 	
 	 2~Tidligere evaluering af samme træning er \textit{:-)} og helbredstilstand \textit{MODERAT}. 
Vælg \textit{TRÆNING}, \textit{KONDITIONSTRÆNING}, \textit{GÅ}, \textit{MODERAT} og tryk videre efter hver handling.
 	\begin{itemize}
 	\item Forventet anbefaling af træningstid er 30 min
 	\end{itemize}	
3.~Tidligere evaluering af samme træning er: \textit{:-(} og helbredstilstand \textit{MEGET GODT}. 
Vælg \textit{TRÆNING}, \textit{KONDITIONSTRÆNING}, \textit{CYKEL}, \textit{MEGET GODT} og tryk videre efter hver handling.
 \begin{itemize}
...
\textbf{Resultat main flow 3:} &  \hspace{1.5mm}
 ...
 \textbf{Resultat main flow 4:} &  \hspace{1.5mm}
    \raisebox{-\totalheight}{\includegraphics[width=0.24\textwidth, height=60mm]{figures/test/notification1}}
      \hspace{5mm}
             \raisebox{-\totalheight}{\includegraphics[width=0.24\textwidth, height=60mm]{figures/test/notification2}} 
      \hspace{5mm}
       \raisebox{-\totalheight}{\includegraphics[width=0.24\textwidth, height=60mm]{figures/test/notification3}} 
   \vspace{3mm}
    \newline
     Resultater for fjerde main flow fremgår af ovenstående figurer. I midten ses det at notifikationen, i øverste venstre hjørne, er startet klokken 15. Udvides notifikationen, ved at slide topbaren ned, ses denne som vist af figuren til højre.
     \\ \hline
\textbf{Resultat:} &
    \begin{itemize}[label={\checkmark}]
...
*********DER SKAL LIGE LAVES EN NY TEST! ***************
  ...
  \textbf{Formål:} & Formålet er, at systemet skal kunne give virtuelle belønninger efter \autoref{tab:SamletBelon}. Dette gøres ved at træne imens, der måles tid og afstand. 
 \\ \hline
 	\textbf{Main flow:} & 1.~Tryk på \textit{TRÆNING} via hovedmenu. \textit{START TRÆNING} og vent 120 minutter. Imens åbnes Extended controls og sæt longitude samt latitude til 0 og tryk send. Ændre herefter til 1.35. \fxnote{SKAL ÆNDRES, SÅ DET PASSER MED CA 25 KM} Tryk \textit{STOP TRÆNING} og evaluer træningen til \textit{:-D}. Tryk herefter på \textit{RESULTATER} via hovedmenuen og vælg \textit{BELØNNINGER}. 
 	\begin{itemize} 
 	\item Forventet, at brugeren har opnået én stjerne som belønning i kategorien antal træninger
 	\item Forventet, at brugeren har opnået tre stjerne som belønning i kategorien tid
  	\item Forventet, at brugeren har opnået to stjerne som belønning i kategorien afstand
    \item Forventet, at brugeren har opnået én stjerne som belønning i kategorien konditionstræning 
  \end{itemize}
\\ \hline
\textbf{Resultat} & \hspace{1.5mm}
        \raisebox{-\totalheight}{\includegraphics[width=0.24\textwidth, height=60mm]{figures/test/belon2}} 
        \hspace{5mm}
       \raisebox{-\totalheight}{\includegraphics[width=0.24\textwidth, height=60mm]{figures/test/belon3}} 
       \hspace{5mm}
      \raisebox{-\totalheight}{\includegraphics[width=0.24\textwidth, height=60mm]{figures/test/belon5}}
        \vspace{3mm}
    \newline
På figurerne ovenfor vises resultaterne for test af resultater. Til venstre fremgår den ønskede tid og afstand. I midten vises, at resultaterne fra træningen gemmes, hvoraf figuren til højre viser belønningerne visualiseret som stjerner. De opnåede stjerner afspejler, at brugeren har udført det antal træninger svarende til de opnåede stjerner. 
  \begin{itemize}[label={\checkmark}]
...
For at teste, hvorvidt kravene til redigering er overholdt, udføres testen, som fremgår af \autoref{tab:testRedigering}.
 ...
 \\ \hline
 	...
 	\begin{itemize}
 	\item Ændring mislykkedes. Fejlmeddelelse vises i grænsefladen for redigering
 	\end{itemize}	
 	...
 	\begin{itemize}
 	\item Ændring lykkedes. Meddelelse viser, at adgangskoden er gemt
 	\end{itemize}
