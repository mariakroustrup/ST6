...
\textbf{Resultat} & \hspace{1.5mm}
    \raisebox{-\totalheight}    {\includegraphics[width=0.24\textwidth, height=60mm]{figures/test/redigering2}} 
      \hspace{5mm}
        \raisebox{-\totalheight}{\includegraphics[width=0.24\textwidth, height=60mm]{figures/test/redigering}} 
      \hspace{5mm}
   \raisebox{-\totalheight}{\includegraphics[width=0.24\textwidth, height=60mm]{figures/test/redigering1}} 
     \vspace{3mm}
    \newline
Ovenstående figurer viser resultater for test af redigering. Til venstre  }
\\ \hline
   \end{tabular}
