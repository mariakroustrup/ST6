...
For at teste om de opstillede krav til databasen er overholdt udføres testen, som fremgår af \autoref{tab:testDatabase}.
  ...
  \begin{longtable}{ | l | p{13cm} |} \hline
    \textbf{Test:} & Database \\ \hline
 	...
 	\begin{itemize}
	\item Bruger er oprettet i databasen (\textbf{\textit{Figur 1}})
	\end{itemize}
...
\begin{itemize}
\item Log ind lykkedes og hovedmenu vises
\end{itemize}
 \\  \hline
...
Vælg \textit{TRÆNING}, \textit{KONDITIONSTRÆNING}, \textit{LØB}, \textit{MEGET DÅRLIGT} og tryk videre efter hver handling.
 	\begin{itemize}
 	\item Anbefaling af træningstid er 15 min
 	\end{itemize} 	
...
Vælg \textit{TRÆNING}, \textit{KONDITIONSTRÆNING}, \textit{CYKEL}, \textit{MEGET GODT} og tryk videre efter hver handling.
 \begin{itemize}
  \item Anbefaling af træningstid er 45 min
  \end{itemize}
 \\  \hline
 \textbf{Resultat:} &\hspace{1.5mm}
...
For at teste om de opstillede krav til resultater er overholdt, udføres testen, der fremgår af \autoref{tab:testResultater}.
 ...
 \\ \hline
 	...
 	\begin{itemize} 
 	\item Grafen viser, at brugeren har trænet 120 minutter på en enkelt dag.
 	\item Brugeren har opnået én stjerne i kategorien antal træninger
 	\item Brugeren har opnået tre stjerner i kategorien tid
  	\item Brugeren har opnået to stjerner i kategorien afstand
    \item Brugeren har opnået én stjerne i kategorien konditionstræning
  \end{itemize}
\\ \hline
\textbf{} & \hspace{0.3mm}
...
For at teste, hvorvidt kravene til redigering er overholdt, udføres testen, som fremgår af \autoref{tab:testRedigering}.
 ...
 \\ \hline
 	...
 	\begin{itemize}
 	\item Log ind lykkes og hovedmenu vises 
	\end{itemize} \\ \hline
\textbf{Resultat} &
