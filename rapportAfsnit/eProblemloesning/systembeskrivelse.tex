...
\item Sundhedspersonalet skal kunne oprette brugere i en database
	\\
	\textit{Dette er nødvendigt for, at brugeren og flere brugere kan anvende app'en}
...
\item Brugere skal kunne evaluere hver træning
	\\
\textit{Dette er nødvendigt for tilpasse træningen efter den enkelte bruger}	
