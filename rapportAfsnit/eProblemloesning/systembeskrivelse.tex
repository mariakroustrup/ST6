...
Dette skal sikre, at det kun er KOL-patienter, der er tilmeldt rehabiliteringshold, som kan benytte app'en. Ved registrering oprettes KOL-patienter med medlemsID, fornavn, efternavn samt adgangskode.  

Der er forskel på, hvor meget fysisk aktivitet KOL-patienter kan udføre, og der skal derved være forskel i varighed og distance af den træning som app'en foreslår. Dertil skal app'en kunne tilpasse træningsniveau ud fra den enkelte patients parametre. Disse parametre består af kategoriseringen af KOL-patienter efter ABCD, jf. \autoref{cha:problemanalyse}, daglige helbredstilstande, der skal tage højde for dag til dag variationer samt evalueringer fra lignende træning. Dette medvirker til at app'en er henvendt specifik til KOL-patienter i modsætningen til andre træningsapp's. 

Under selve træningen monitoreres træningen ved brug af timer og GPS, derudover kan app'en tilkobles eksterne måleenheder. Monitoreringen er med til at vejlede patienten til at følge det valgte træningsniveau. Eksterne måleenheder, for eksempel et pulsur, kan støtte patienten i forhold til at kontrollere, at patienten ikke overanstrenges. 
