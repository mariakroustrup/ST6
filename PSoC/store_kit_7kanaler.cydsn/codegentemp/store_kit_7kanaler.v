// ======================================================================
// store_kit_7kanaler.v generated from TopDesign.cysch
// 04/20/2016 at 11:16
...
module ADC_SAR_SEQ_P4_v2_30_1 (
    ...
    electrical  Net_1851;
    electrical  Net_2580;
    electrical [6:0] Net_2375;
    electrical [6:0] Net_1450;
    electrical  Net_3046;
    electrical  Net_3016;
          wire  Net_3235;
    electrical  Net_2099;
    ...
    Bus_Connect_v2_20 Connect_1 (
        ...
        .out_bus(Net_1450[6:0]));
    defparam Connect_1.in_width = 17;
    defparam Connect_1.out_width = 7;
	...
	cy_connect_v1_0 cy_analog_virtualmux_37_connect(Net_3016, mux_bus_plus[7]);
	...
	cy_connect_v1_0 cy_analog_virtualmux_36_connect(Net_3046, mux_bus_minus[7]);
    ...
    Bus_Connect_v2_20 Connect_2 (
        ...
        .out_bus(Net_2375[6:0]));
    defparam Connect_2.in_width = 17;
    defparam Connect_2.out_width = 7;
    ...
    cy_psoc4_sarmux_v1_0 cy_psoc4_sarmux_8 (
        .muxin_plus(Net_1450[6:0]),
        .muxin_minus(Net_2375[6:0]),
        .cmn_neg(Net_2580),
        .vout_plus(Net_2794),
        .vout_minus(Net_2793));
    defparam cy_psoc4_sarmux_8.input_mode = "0000000";
    defparam cy_psoc4_sarmux_8.muxin_width = 7;
...
module top ;
	...
	wire [0:0] tmpOE__Y_1_net;
	wire [0:0] tmpFB_0__Y_1_net;
	wire [0:0] tmpIO_0__Y_1_net;
	wire [0:0] tmpINTERRUPT_0__Y_1_net;
	electrical [0:0] tmpSIOVREF__Y_1_net;

	cy_psoc3_pins_v1_10
		#(.id("d8838586-971b-47ae-a400-5e4b80447c28"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Y_1
		 (.oe(tmpOE__Y_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Y_1_net[0:0]}),
		  .analog({Net_307}),
		  .io({tmpIO_0__Y_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Y_1_net),
		  .interrupt({tmpINTERRUPT_0__Y_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Y_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__X_2_net;
	wire [0:0] tmpFB_0__X_2_net;
	wire [0:0] tmpIO_0__X_2_net;
	wire [0:0] tmpINTERRUPT_0__X_2_net;
	electrical [0:0] tmpSIOVREF__X_2_net;

	cy_psoc3_pins_v1_10
		#(.id("6c21055e-c23f-4206-baaf-42c973efe64c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		X_2
		 (.oe(tmpOE__X_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__X_2_net[0:0]}),
		  .analog({Net_304}),
		  .io({tmpIO_0__X_2_net[0:0]}),
		  .siovref(tmpSIOVREF__X_2_net),
		  .interrupt({tmpINTERRUPT_0__X_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__X_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Z_2_net;
	wire [0:0] tmpFB_0__Z_2_net;
	wire [0:0] tmpIO_0__Z_2_net;
	wire [0:0] tmpINTERRUPT_0__Z_2_net;
	electrical [0:0] tmpSIOVREF__Z_2_net;

	cy_psoc3_pins_v1_10
		#(.id("c5695276-c149-43f3-a89b-c22b7919b216"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Z_2
		 (.oe(tmpOE__Z_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Z_2_net[0:0]}),
		  .analog({Net_308}),
		  .io({tmpIO_0__Z_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Z_2_net),
		  .interrupt({tmpINTERRUPT_0__Z_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Z_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("35140937-84aa-472d-b9c6-cf14c19ce7f7"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
