...
num_of_channels = 7;    % Antallet af kanaler
...
samples_per_channel = 18; % Antal samples per læsning fra porten
...
if port_open                        % Kør kun nedenstående, hvis porten kunne åbnes
    ...
    while ~strcmp(key,'q')          % while-løkken stoppes ved at trykke på "q"-tasten
        ...
        plot(data)                              % Plot data
        axis([0 data_length -3000 2^11+50])  % Tilpas akserne
        legend('X-akse','Y-akse','Z-akse','X1-akse','Y1-akse','Z1-akse', 'EMG');
